  ...
  return (
    <div className="w-[350px] p-4">
      <div className="flex justify-between items-center border-b-2 pb-2 mb-2">
        <div className="text-2xl font-bold">Skelly</div>
        <Button className="bg-purple-950 text-white">$Donate$</Button>
      </div>
      <div className="grid gap-4">
        ...
        />
        <div>
          <label className="text-sm mb-1 block font-medium text-gray-900">
            Select default theme
          </label>
          <Select
            onChange={handleSetDefaultTheme}
            options={themes}
            defaultValue={defaultThemeValue ?? 'none'}
          />
        </div>
        <div className="flex justify-between">
          <Button
            onClick={handleViewInSkellyClick}
            className="bg-emerald-900 text-white"
          >
            View in Skelly
          </Button>
          <Button className="bg-emerald-300" onClick={handleCryptoClick}>
            Open Crypto
          </Button>
        </div>
      </div>
